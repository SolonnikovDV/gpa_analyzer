...
class DetailedGreenplumFunctionAnalyzer:
    ...
    def analyze_with_user_sizes(
        ...
        agent_stack: Optional[str] = None,
        agent_multi_agent: Optional[bool] = None,
    ) -> Dict:
        ...
        if self.input_type == 'function':
            return self._analyze_function_with_user_sizes(
                ...
                agent_multi_agent=agent_multi_agent,
            )
        else:
    ...
    def _analyze_function_with_user_sizes(
        ...
        if use_agent_plan:
            ...
            try:
                from modules.agents.gigachat_agent import clear_agent_errors
                clear_agent_errors()
            except Exception:
                pass
        else:
            ...
            if block_parser.is_executable_sql(block_type) or is_execute:
                ...
                if clean_sql:
                    ...
                    if plan_json is None:
                        try:
                            from modules.agents.agent_cache_db import get_plan
                    ...
                    if plan_json is None:
                        if use_agent_plan and agent_credentials:
                            try:
                                from modules.agents.gigachat_agent import synthesize_plan_for_query
                        ...
                        if plan_json:
                            self.plan_cache[cache_key] = plan_json
                            try:
                                from modules.agents.agent_cache_db import set_plan
    ...
    def _get_agent_errors(self) -> List[Dict]:
        ...
        try:
            from modules.agents.gigachat_agent import get_recent_agent_errors
