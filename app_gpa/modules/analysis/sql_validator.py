...
from core.paths import APP_DIR, SQL_FUNCTION_CACHE_PATH, SQL_FUNCTION_PROFILES_PATH

_APP_GPA_DIR = APP_DIR
_SQL_FUNCTION_CACHE_PATH = SQL_FUNCTION_CACHE_PATH
_SQL_FUNCTION_PROFILES_PATH = SQL_FUNCTION_PROFILES_PATH
