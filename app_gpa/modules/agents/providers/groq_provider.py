...
class GroqProvider:
    ...
    def info(self) -> ProviderInfo:
        from ..models.groq import DEFAULT_CHAT_MODEL, FREE_CHAT_MODELS

        return ProviderInfo(
            id=self.id,
            label="Groq (free · 14 400 req/day)",
            default_chat_model=os.environ.get("GROQ_MODEL") or DEFAULT_CHAT_MODEL,
    ...
    def chat(
        ...
        **kwargs: Any,
        ...
        from ..models.groq import chat as _chat
